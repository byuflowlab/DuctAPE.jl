...
datapath = project_dir * "/dev_debug_archive/isolated_archive/rotor_only/"
...
# savefig("dev_debug_archive/isolated_archive/rotor_only/apc_chord.pdf")
# plot(r, twists, xlabel=L"r/R_\mathrm{tip}", ylabel="twist (deg)",label="",ylim=(0.0,39),xlim=(0.0,1.0))
# savefig("dev_debug_archive/isolated_archive/rotor_only/apc_twist.pdf")
...
inputs = dt.precompute_inputs_rotor_only(
    rotor_parameters, freestream; wake_length=wake_length
)

plot_rotor_geometry(inputs, datapath; num=true)

init_states = dt.initilize_states_rotor_only(inputs)

Gamr, gamw, sigr = dt.extract_rotor_states(init_states, inputs)
...
# for i in 1:1
    ...
    @time begin
        ...
        savefig("dev_debug_archive/isolated_archive/rotor_only/Circulation_J$(J[i]).pdf")
        ...
        #     label="initial",
        # )
        # plot!(pw, gamwconv, inputs.rotor_panel_edges; label="converged")
        # savefig("dev_debug_archive/isolated_archive/rotor_only/wake-strengths_J$(J[i]).pdf")

        ps = plot(
            sigr, inputs.rotor_panel_centers; xlabel=L"\sigma", ylabel="r", label="initial"
        )
        plot!(ps, sigrconv, inputs.rotor_panel_centers; label="converged")
        savefig("dev_debug_archive/isolated_archive/rotor_only/source-strenghts_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/chord_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/twist_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/vtheta_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/Wtheta_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/Wm_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/phi_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/alpha_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/W_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/cl_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/cd_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/cn_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/ct_J$(J[i]).pdf")
    ...
    savefig("dev_debug_archive/isolated_archive/rotor_only/distributed_loads_J$(J[i]).pdf")
end
...
savefig("dev_debug_archive/isolated_archive/rotor_only/rotor-only-thrust-and-power-validation.pdf")
# savefig("dev_debug_archive/isolated_archive/rotor_only/rotor-only-thrust-and-power-validation.png")
...
savefig("dev_debug_archive/isolated_archive/rotor_only/rotor-only-efficiency-validation.pdf")
# savefig("dev_debug_archive/isolated_archive/rotor_only/rotor-only-efficiency-validation.png")
