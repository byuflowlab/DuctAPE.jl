...
include(project_dir * "/dev_debug_archive/dfdc_comp/dfdccp.jl")
#test to make sure you have the right indices
include(project_dir * "/dev_debug_archive/dfdc_comp/CPR_duct.jl")
...
include(project_dir * "/dev_debug_archive/dfdc_comp/DFDC_printout.jl")
...
function init()
    ...
    # airfoils = fill(ccb.AlphaAF("dev_debug_archive/dfdc_comp/dfdc_polar.dat"), length(r))
    ...
    include(project_dir * "/dev_debug_archive/dfdc_comp/dfdc_ductgeom.jl")
...
function plot_output_geometry(inputs)
    ...
    savefig(project_dir * "/dev_debug_archive/dfdc_comp/wakeandpseudowakegeom.pdf")
...
function plotgeom(inputs, paneling_constants)
    ...
    savefig(project_dir * "/dev_debug_archive/dfdc_comp/precomputed-rotor-wake-geometry.pdf")
    ...
    savefig(pgeom, project_dir * "/dev_debug_archive/dfdc_comp/precomputed-full-geometry.pdf")
...
function plotstates(Gamr, sigr, gamw, inputs, convergeflag)
    ...
    #save
    savefig(pG, project_dir * "/dev_debug_archive/dfdc_comp/rotorcirculation-check.pdf")
    ...
    ##save
    #savefig(pg, project_dir * "/dev_debug_archive/dfdc_comp/wake-strength.pdf")
    ...
    #save
    savefig(ps, project_dir * "/dev_debug_archive/dfdc_comp/source-strength-check.pdf")
...
function plotbodyaero(cstates, inputs, out,convergeflag)
    ...
    #save
    savefig(pb, project_dir * "/dev_debug_archive/dfdc_comp/body-velocity.pdf")
    ...
    #save
    savefig(pcp, project_dir * "/dev_debug_archive/dfdc_comp/body-pressure.pdf")
...
function plotbladevelocities(cdump, inputs)
    ...
    savefig(pvx, project_dir * "/dev_debug_archive/dfdc_comp/VXcomp.pdf")
    ...
    savefig(pvr, project_dir * "/dev_debug_archive/dfdc_comp/VRcomp.pdf")
    ...
    savefig(pvt, project_dir * "/dev_debug_archive/dfdc_comp/Vthetacomp.pdf")

    plot!(pw, cdump.Wmag_rotor, rpc; label="W")
    plot!(pw, dfdcWmag, dfdcr; label="DFDC W")
    savefig(pw, project_dir * "/dev_debug_archive/dfdc_comp/Wmagcomp.pdf")

    plot!(por, omega * rpc, rpc; label="DuctAPE")
    plot!(por, omega * dfdcr, dfdcr; linewidth=2, linestyle=:dash, label="DFDC")
    savefig(por, project_dir * "/dev_debug_archive/dfdc_comp/Omegarcomp.pdf")
...
function plotangles(cdump, inputs)
    ...
    savefig(pa, project_dir * "/dev_debug_archive/dfdc_comp/anglescomp.pdf")
...
function ploths(cdump, inputs)
    ...
    savefig(ph, project_dir * "/dev_debug_archive/dfdc_comp/Htildecomp.pdf")
    savefig(ps, project_dir * "/dev_debug_archive/dfdc_comp/Stildecomp.pdf")
