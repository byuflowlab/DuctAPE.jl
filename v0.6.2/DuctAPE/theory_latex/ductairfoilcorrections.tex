...
\begin{figure}[htb]
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
        \input{figures/liftstall-cutoff.tikz}
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
         \input{figures/dragstall-cutoff.tikz}
...
%
\begin{marginfigure}
	\input{figures/soliditystagger-correction-margin.tikz}
...
\begin{figure}[htb]
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
        \input{figures/solidity-smoothed.tikz}
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
         \input{figures/stagger-smoothed.tikz}
...
\begin{marginfigure}
	\input{figures/prandtlglauert-correction-margin.tikz}
...
\begin{marginfigure}
	\input{figures/pg-smoothed-margin.tikz}
...
\begin{marginfigure}
	\input{figures/redrag-correction-margin.tikz}
...
\begin{marginfigure}
	\input{figures/clminmaxlimit-correction-margin.tikz}
...
\begin{marginfigure}
	\input{figures/transdrag-correction-margin.tikz}
...
\begin{figure}[htb]
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
        \input{figures/cltranslim-smoothed.tikz}
        % \label{fig:cltranslim-smoothed}
     \end{subfigure}
     \hfill
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
         \input{figures/cdtranslim-smoothed.tikz}
...
\begin{figure}[hb!]
    \centering
        \input{figures/naca-65410scaled.tikz}%
...
\begin{figure}[h!]
     ...
     \begin{subfigure}[t]{\textwidth}
         \centering
        \input{figures/naca_65410_clcd_b30_comp.tikz}%
     ...
     \begin{subfigure}[t]{\textwidth}
         \centering
        \input{figures/naca_65410_clcd_b45_comp.tikz}%
     ...
     \begin{subfigure}[t]{\textwidth}
         \centering
        \input{figures/naca_65410_clcd_b60_comp.tikz}%
     ...
     \begin{subfigure}[t]{\textwidth}
         \centering
         \raisebox{-4em}{\input{figures/naca_65410_clcd_b70_comp.tikz}}%
