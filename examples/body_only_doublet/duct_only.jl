...
=#
duct_panels = dt.generate_panels(duct_coordinates)

##### ----- Visualize to Check ----- #####
visualize_paneling(duct_panels; coordinates=duct_coordinates, control_points=true, nodes=true, normals=true, savepath=savepath, filename="duct-geometry.pdf")
