...
##### ----- Visualize to Check ----- #####
visualize_paneling(panels; coordinates=coordinates, control_points=true, nodes=true, TEnodes=true, normals=true, savepath=savepath, filename="duct-geometry.pdf")
