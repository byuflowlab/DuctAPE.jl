...
savefig(pgeom, project_dir * "/examples/duct_only/bodygeomforvx.pdf")
savefig(pv, project_dir * "/examples/duct_only/bodyvx.pdf")
savefig(pg, project_dir * "/examples/duct_only/bodyvs.pdf")
