...
function step_through(;
    ...
    println("\nSaving Figures...")
    # - states - #
    savefig(pgb, project_dir * "/examples/step_through/body-strengths.pdf")
    savefig(pgw, project_dir * "/examples/step_through/wake-strengths.pdf")
    savefig(ps, project_dir * "/examples/step_through/source-strengths.pdf")
    savefig(pG, project_dir * "/examples/step_through/circulation-strengths.pdf")

    # - velocities - #
    savefig(pvx, project_dir * "/examples/step_through/vx.pdf")
    savefig(pvr, project_dir * "/examples/step_through/vr.pdf")
    savefig(pvt, project_dir * "/examples/step_through/vtheta.pdf")
    savefig(pwm, project_dir * "/examples/step_through/wm.pdf")
    savefig(pwmag, project_dir * "/examples/step_through/wmag.pdf")
    savefig(pwt, project_dir * "/examples/step_through/wtheta.pdf")
