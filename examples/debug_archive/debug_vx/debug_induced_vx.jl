...
savefig(
    project_dir * "/examples/debug_vx/isolated-wake-induced-velocities-on-rotor-plane.pdf"
)

plot(; xlabel="wake strengths", ylabel="r")
plot!(rogamw, inputs.rotor_panel_edges; label="")
savefig(project_dir * "/examples/debug_vx/isolated-wake-strengths.pdf")
...
for jwake in 1:nwake_sheets
    ...
    savefig(
        pcont, project_dir * "/examples/debug_vx/wake$(jwake)-on-body-influence-matrix.pdf"
    )
end
...
savefig(
    pii,
    project_dir *
    "/examples/debug_vx/individual-wake-induced-velocities-on-inner-body-surface.pdf",
)
savefig(
    pio,
    project_dir *
    "/examples/debug_vx/individual-wake-induced-velocities-on-outer-body-surface.pdf",
)

# savefig(
#     pci,
#     project_dir *
#     "/examples/debug_vx/individual-UNIT-wake-induced-velocities-on-inner-body-surface.pdf",
# )
# savefig(
#     pco,
#     project_dir *
#     "/examples/debug_vx/individual-UNIT-wake-induced-velocities-on-outer-body-surface.pdf",
# )
...
savefig(
    project_dir * "/examples/debug_vx/isolated-wake-induced-velocities-on-body-surface.pdf"
)
...
savefig(project_dir * "/examples/debug_vx/isolated-body-panel-strength-sanity-check.pdf")
...
savefig(pcont, project_dir * "/examples/debug_vx/body-on-body-influence-matrix.pdf")
...
plot!(vr, inputs.rotor_source_panels[1].panel_center[:, 2]; label=L"v_r")
savefig(
    project_dir * "/examples/debug_vx/isolated-body-induced-velocities-on-rotor-plane.pdf"
)
...
savefig(pcont, project_dir * "/examples/debug_vx/body-on-rotor-influence-matrix.pdf")
