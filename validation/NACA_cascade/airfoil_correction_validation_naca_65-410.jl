...
include(dispath * "/smoothing_plots_default.jl")

# - load experimental data - #
include(project_dir * "/test/data/NACA_cascade_data_65-410.jl")
...
f = open(dispath * "naca-65410scaled.dat", "w")
...
savefig(savepath * "naca-65410scaled.pdf")
...
# spline data
a245sm = range(minimum(a245g), maximum(a245g), 100)
cl245sm = FLOWMath.akima(a245g, cl245g, a245sm)
cd245sm = FLOWMath.akima(a245g, cd245g, a245sm)
...
# spline data
a200sm = range(minimum(a200g), maximum(a200g), 100)
cl200sm = FLOWMath.akima(a200g, cl200g, a200sm)
cd200sm = FLOWMath.akima(a200g, cd200g, a200sm)
...
clmin200, clminid200 = findmin(cl200sm[5:end])
clminid200 += 5
clmax200, clmaxid200 = findmax(cl200sm[1:23])
clcdmin200 = cl200sm[findmin(cd200sm)[2]]
dclda200 = (clmax200 - clmin200) / ((a200sm[clmaxid200] - a200sm[clminid245]) * pi / 180.0)
...
savefig(ppl245, savepath * "naca_65410_cl_re245000.pdf")
savefig(ppd245, savepath * "naca_65410_cd_re245000.pdf")
savefig(ppl200, savepath * "naca_65410_cl_re200000.pdf")
savefig(ppd200, savepath * "naca_65410_cd_re200000.pdf")
...
cd_b30_s100_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b30s100[:, 1] * pi / 180)

#plot isolated airfoil
plot!(pbl30, a245sm, cl245sm; label="", color=mygrey, linestyle=:dash)
plot!(pbd30, a245sm, cd245sm; label="", color=mygrey, linestyle=:dash)
...
plot!(pbl30, cl_b30s100[:, 1], cl_b30_s100_r245; label="", color=1)
plot!(pbd30, cl_b30s100[:, 1], cd_b30_s100_r245; label="", color=1)

##### ----- Solidity = 1.25 ----- #####
cl_b30_s125_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b30s125[:, 1] * pi / 180)
cd_b30_s125_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b30s125[:, 1] * pi / 180)
...
plot!(pbl30, cl_b30s125[:, 1], cl_b30_s125_r245; label="", color=2)
plot!(pbd30, cl_b30s125[:, 1], cd_b30_s125_r245; label="", color=2)

##### ----- Solidity = 1.5 ----- #####
cl_b30_s150_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b30s150[:, 1] * pi / 180)
cd_b30_s150_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b30s150[:, 1] * pi / 180)
for (a, cl, cd) in
...
plot!(pbl30, cl_b30s150[:, 1], cl_b30_s150_r245; label="", color=3)
plot!(pbd30, cl_b30s150[:, 1], cd_b30_s150_r245; label="", color=3)

savefig(pbl30, savepath * "naca_65410_cl_b30_comp.pdf")
savefig(pbd30, savepath * "naca_65410_cd_b30_comp.pdf")
pbld30 = plot(pbl30, pbd30; layout=(1, 2), size=(500, 200))
savefig(pbld30, dispath * "naca_65410_clcd_b30_comp.tikz")
...
#     )
# end
# plot!(pbl45, cl_b45s050[:, 1], cl_b45_s050_r200; label="")
# plot!(pbd45, cd_b45s050[:, 1], cd_b45_s050_r200; label="")
...
#     )
# end
# plot!(pbl45, cl_b45s075[:, 1], cl_b45_s075_r200; label="")
# plot!(pbd45, cd_b45s075[:, 1], cd_b45_s075_r200; label="")

##### ----- Solidity = 1.0 ----- #####
cl_b45_s100_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b45s100[:, 1] * pi / 180)
cd_b45_s100_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b45s100[:, 1] * pi / 180)

#plot isolated airfoil
plot!(pbl45, a245sm, cl245sm; label="", color=mygrey, linestyle=:dash)
plot!(pbd45, a245sm, cd245sm; label="", color=mygrey, linestyle=:dash)
...
plot!(pbl45, cl_b45s100[:, 1], cl_b45_s100_r245; label="", color=1)
plot!(pbd45, cl_b45s100[:, 1], cd_b45_s100_r245; label="", color=1)

##### ----- Solidity = 1.25 ----- #####
cl_b45_s125_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b45s125[:, 1] * pi / 180)
cd_b45_s125_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b45s125[:, 1] * pi / 180)
...
plot!(pbl45, cl_b45s125[:, 1], cl_b45_s125_r245; label="", color=2)
plot!(pbd45, cl_b45s125[:, 1], cd_b45_s125_r245; label="", color=2)

##### ----- Solidity = 1.5 ----- #####
cl_b45_s150_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b45s150[:, 1] * pi / 180)
cd_b45_s150_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b45s150[:, 1] * pi / 180)
for (a, cl, cd) in
...
plot!(pbl45, cl_b45s150[:, 1], cl_b45_s150_r245; label="", color=3)
plot!(pbd45, cl_b45s150[:, 1], cd_b45_s150_r245; label="", color=3)

savefig(pbl45, savepath * "naca_65410_cl_b45_comp.pdf")
savefig(pbd45, savepath * "naca_65410_cd_b45_comp.pdf")
pbld45 = plot(pbl45, pbd45; layout=(1, 2), size=(500, 200))
savefig(pbld45, dispath * "naca_65410_clcd_b45_comp.tikz")
...
#     )
# end
# plot!(pbl60, cl_b60s050[:, 1], cl_b60_s050_r200; label="")
# plot!(pbd60, cd_b60s050[:, 1], cd_b60_s050_r200; label="")
...
#     )
# end
# plot!(pbl60, cl_b60s075[:, 1], cl_b60_s075_r200; label="")
# plot!(pbd60, cd_b60s075[:, 1], cd_b60_s075_r200; label="")

##### ----- Solidity = 1.0 ----- #####
cl_b60_s100_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b60s100[:, 1] * pi / 180)
cd_b60_s100_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b60s100[:, 1] * pi / 180)

#plot isolated airfoil
plot!(pbl60, a245sm, cl245sm; label="", color=mygrey, linestyle=:dash)
plot!(pbd60, a245sm, cd245sm; label="", color=mygrey, linestyle=:dash)
...
plot!(pbl60, cl_b60s100[:, 1], cl_b60_s100_r245; label="", color=1)
plot!(pbd60, cl_b60s100[:, 1], cd_b60_s100_r245; label="", color=1)

##### ----- Solidity = 1.25 ----- #####
cl_b60_s125_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b60s125[:, 1] * pi / 180)
cd_b60_s125_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b60s125[:, 1] * pi / 180)
...
plot!(pbl60, cl_b60s125[:, 1], cl_b60_s125_r245; label="", color=2)
plot!(pbd60, cl_b60s125[:, 1], cd_b60_s125_r245; label="", color=2)

##### ----- Solidity = 1.5 ----- #####
cl_b60_s150_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b60s150[:, 1] * pi / 180)
cd_b60_s150_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b60s150[:, 1] * pi / 180)
for (a, cl, cd) in
...
plot!(pbl60, cl_b60s150[:, 1], cl_b60_s150_r245; label="", color=3)
plot!(pbd60, cl_b60s150[:, 1], cd_b60_s150_r245; label="", color=3)

savefig(pbl60, savepath * "naca_65410_cl_b60_comp.pdf")
savefig(pbd60, savepath * "naca_65410_cd_b60_comp.pdf")
pbld60 = plot(pbl60, pbd60; layout=(1, 2), size=(500, 200))
savefig(pbld60, dispath * "naca_65410_clcd_b60_comp.tikz")
...
cd_b70_s100_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b70s100[:, 1] * pi / 180)

#plot isolated airfoil
plot!(pbl70, a245sm, cl245sm; label="", color=mygrey, linestyle=:dash)
plot!(pbd70, a245sm, cd245sm; label="", color=mygrey, linestyle=:dash)
...
plot!(pbl70, cl_b70s100[:, 1], cl_b70_s100_r245; label="", color=1)
plot!(pbd70, cl_b70s100[:, 1], cd_b70_s100_r245; label="", color=1)

##### ----- Solidity = 1.25 ----- #####
cl_b70_s125_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b70s125[:, 1] * pi / 180)
cd_b70_s125_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b70s125[:, 1] * pi / 180)
...
plot!(pbl70, cl_b70s125[:, 1], cl_b70_s125_r245; label="", color=2)
plot!(pbd70, cl_b70s125[:, 1], cd_b70_s125_r245; label="", color=2)

##### ----- Solidity = 1.5 ----- #####
cl_b70_s150_r245 = FLOWMath.akima(a245ext, cl245ext, cl_b70s150[:, 1] * pi / 180)
cd_b70_s150_r245 = FLOWMath.akima(a245ext, cd245ext, cl_b70s150[:, 1] * pi / 180)
for (a, cl, cd) in
...
plot!(pbl70, cl_b70s150[:, 1], cl_b70_s150_r245; label="", color=3)
plot!(pbd70, cl_b70s150[:, 1], cd_b70_s150_r245; label="", color=3)

savefig(pbl70, savepath * "naca_65410_cl_b70_comp.pdf")
savefig(pbd70, savepath * "naca_65410_cd_b70_comp.pdf")
# savefig(pbl70, dispath * "naca_65410_cl_b70_comp.tikz")
pbld70 = plot(pbl70, pbd70; layout=(1, 2), size=(500, 200))
savefig(pbld70, dispath * "naca_65410_clcd_b70_comp.tikz")
