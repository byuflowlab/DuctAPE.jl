...
\begin{figure}[htb]
     ...
     \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \input{./rotor_wake_method/figures/wake_screw.tikz}
     ...
     \begin{subfigure}[t]{0.45\textwidth}
         \centering
        \input{./rotor_wake_method/figures/smeared_cylinder.tikz}
...
\begin{figure}[h!]
    \centering
    \input{./rotor_wake_method/figures/swirl_velocity_from_circulation.tikz}
