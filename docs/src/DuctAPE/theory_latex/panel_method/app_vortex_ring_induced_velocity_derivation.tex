...
After that tedious algebra, we arrive at the following expressions for the unit\sidenote{In other words, we have set \(\gamma=1\)} induced velocity due to a vortex ring.
\begin{subequations}
