...
\newcommand\ImageNode[3][]{
  \node[#1] (#2) {\includegraphics[width=1.5cm,height=1.5cm]{#3}};
}
...
\renewcommand*{\parttitlefont}{\normalfont\Huge\sffamily\itshape\colorchaptitle}
...
%
	\mdfsetup{
		...
		linewidth=0.75pt,%
		topline=true,%
		frametitleaboveskip=\dimexpr-0.5\ht\strutbox\relax,%
...
% format the inline \cref text: #2 #1 #3 are cleveref's hook pieces
\crefformat{figure}{figure~\textcolor{primary}{#2#1#3}}
\Crefformat{figure}{Figure~\textcolor{primary}{#2#1#3}}

\crefformat{subfigure}{figure~\textcolor{primary}{#2#1#3}}
\Crefformat{subfigure}{Figure~\textcolor{primary}{#2#1#3}}

% optional: also color ranges and multiple refs consistently
\crefrangeformat{figure}{figures~\textcolor{primary}{#3#1#4--#5#2#6}}
\crefrangeformat{subfigure}{figures~\textcolor{primary}{#3#1#4--#5#2#6}}

% multiple references (a,b)
\crefmultiformat{figure}{figures~\textcolor{primary}{#2#1#3}}%
  { and~\textcolor{primary}{#2#1#3}}%
  {, \textcolor{primary}{#2#1#3}}%
  { and~\textcolor{primary}{#2#1#3}}
\Crefmultiformat{figure}{Figures~\textcolor{primary}{#2#1#3}}%
  { and~\textcolor{primary}{#2#1#3}}%
  {, \textcolor{primary}{#2#1#3}}%
...
\crefmultiformat{subfigure}{figures~\textcolor{primary}{#2#1#3}}%
  { and~\textcolor{primary}{#2#1#3}}%
  {, \textcolor{primary}{#2#1#3}}%
  { and~\textcolor{primary}{#2#1#3}}
\Crefmultiformat{subfigure}{Figures~\textcolor{primary}{#2#1#3}}%
...
\newdimen\figrasterwd
\figrasterwd=\dimexpr\textwidth+2.0in\relax
\usepackage{placeins}
\usepackage{overpic}
...
% custom line colors for tables
\usepackage{colortbl}
\arrayrulecolor{mediumgray}

% S column type in tables
