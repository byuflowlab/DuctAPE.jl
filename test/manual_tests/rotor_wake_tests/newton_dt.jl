...
savefig(params.pW, "test/manual_tests/rotor_wake_tests/newton_W.png")
savefig(params.pa, "test/manual_tests/rotor_wake_tests/newton_aoa.png")
savefig(params.pcl, "test/manual_tests/rotor_wake_tests/newton_cl.png")
savefig(params.pcd, "test/manual_tests/rotor_wake_tests/newton_cd.png")
savefig(params.pg, "test/manual_tests/rotor_wake_tests/newton_circ.png")
savefig(params.pgw, "test/manual_tests/rotor_wake_tests/newton_wakegamma.png")
savefig(params.pvm, "test/manual_tests/rotor_wake_tests/newton_vms.png")
