...
Vinf = 1.0
x, r = ff.naca4(4.0, 4.0, 12.0)
r .*= -1.0
r .+= 100.0
coordinates = [reverse(x) reverse(r)]
...
savefig("test/manual_tests/flipped_4412_surface_velocity.pdf")
...
savefig("test/manual_tests/flipped_4412_surface_pressure.pdf")
...
savefig("test/manual_tests/flipped_4412_off_body_case_1.pdf")

savefig(geom, "test/manual_tests/nacaflipped_4412_off_body_geometry.pdf")
