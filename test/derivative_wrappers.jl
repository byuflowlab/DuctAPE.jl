...
function dt_full_wrapper(inputs)
    ...
    outputs = [
        ...
        out.blade_normal_force_per_unit_span[1]
...
function dt_prepost_wrapper(inputs)
    ...
    initial_states = dt.initialize_states(precomps)
    ...
    # outputs = [mub[1], gamw[1], Gamr[1], sigr[1]]
